module Shoppe
  ...
  class Country < ActiveRecord::Base
    ...
    has_many :billed_orders, :dependent => :restrict, :class_name => 'Shoppe::Order', :foreign_key => 'billing_country_id'
    
    # All orders which have this country set as their delivery country
    has_many :delivered_orders, :dependent => :restrict, :class_name => 'Shoppe::Order', :foreign_key => 'delivery_country_id'
